...
const AbacusTrainingPage = () => {
  ...
  const fetchAll = async () => {
    try {
      const { data } = await API.get('/teacher-training?type=abacus')
      setItems(data.data)
    } catch {}
  }
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-gray-800">Abacus Teacher Training</h2>
        {!showForm && (
          <button
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input name="slug" value={form.slug} onChange={handleChange} required
                placeholder="abacus-teacher-training"
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400" />
            </div>
            ...
            <div>
              ...
              <input name="duration" value={form.duration} onChange={handleChange}
                placeholder="e.g. 40 days self-paced"
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400" />
            </div>
            ...
            <div>
              ...
              <input name="fee" value={form.fee} onChange={handleChange}
                placeholder="e.g. INR 19900 / USD 275"
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400" />
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {items.length === 0 ? (
              <tr><td colSpan={6} className="text-center py-8 text-gray-400">No abacus training programs yet.</td></tr>
            ) : items.map((item) => (
